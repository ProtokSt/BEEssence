...
function OnRemoveMiamsa(reveal, removeFoW)
	print("PWE_RemoveMiamsa"..", reveal="..getstr(reveal)..", removeFoW="..getstr(removeFoW));
end
LuaEvents.PWE_RemoveMiamsa.Add(OnRemoveMiamsa);

function OnRemovePods(reveal, removeFoW)
	print("PWE_RemovePods"..", reveal="..getstr(reveal)..", removeFoW="..getstr(removeFoW));
end
LuaEvents.PWE_RemovePods.Add(OnRemovePods);

function OnRemoveAliensClick(reveal, removeFoW)
	print("PWE_RemoveAliens"..", reveal="..getstr(reveal)..", removeFoW="..getstr(removeFoW));
end
LuaEvents.PWE_RemoveAliens.Add(OnRemoveAliensClick);

function OnSetWild0Click(reveal, removeFoW)
	print("PWE_SetWild0"..", reveal="..getstr(reveal)..", removeFoW="..getstr(removeFoW));
end
LuaEvents.PWE_SetWild0.Add(OnSetWild0Click);
