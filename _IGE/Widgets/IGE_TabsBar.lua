...
function OnInitialize()
	...
	local tempsizeX, tempsizeY = UIManager:GetScreenSizeVal();
	if tempsizeX < 1280 then
	...
	--if sizeY < 1000 then --Always use small setup
		smallLayout = true;
		...
		Controls.LowerFrame:SetSizeX(mainGridX);
		Controls.Container:SetSizeX(mainGridX);
		Controls.TabsGrid:SetSizeX(mainGridX);
