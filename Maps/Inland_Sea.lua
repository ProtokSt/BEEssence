...
function GetMapScriptInfo()
	...
	return {
		...
		Type = "TXT_KEY_MAP_INLAND_SEA_TYPE",--MGH
		Description = "TXT_KEY_MAP_INLAND_SEA_HELP",
		IsAdvancedMap = false,
		IconIndex = 1,--MGH (old:12)
		-- FiraxisLiveKey = "InlandSeaUnlocked",
...
function GetMapInitData(worldSize)
	g_StartingsOption = Map.GetCustomOption(7); -- GLOBAL variable.
...
function StartPlotSystem()
	...
	-- Regional Division Method 4: Rectangular with given
	...
	print("Choosing start locations for civilizations (Lua Inland Sea)");
	args = {
		...
		minGoodOuter = 8,
		maxJunk = 10,	
		chooseStartCondition = 3,
		};
	start_plot_database:ChooseLocations(args)

	
	print("Normalizing start locations and assigning them to Players (Lua Inland Sea)");
	args = {
		};
	start_plot_database:BalanceAndAssign()

	print("Placing Resources and City States (Lua Inland Sea)");
