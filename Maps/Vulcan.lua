...
function MultilayeredFractal:GeneratePlotsByRegion()
	...
	-- Lake density
	local lake_list = {92+2, 89+2, 85+2}; --MGH
	local lake_grains = {5+2, 4+1, 3}; --MGH
...
function GenerateTerrain()
	...
	local args = {temperature = temp, fSnowLatitude = 0.92}; --MGH (old: 0.85)
...
function StartPlotSystem()
	...
	local res = Map.GetCustomOption(4) -- this map has Resource option on number 4
	if res == 6 then
