...
do
	...
	for questInfo in GameInfo.Quests() do
		repeat
			...
			--if(not (questInfo.ScriptName == "GeneticEntanglementQuest" or questInfo.ScriptName == "AncillaryAdamsQuest")) then--test
			if(Game.IsNetworkMultiPlayer() and questInfo.ScriptName ~="BuildingChoiceTemplateQuest") then
